      ...
      <Router>
        <Routes>
          ...
          <Route
            ...
            exact
            element={<UserCreateTicket />}
          />
          <Route
            path="/user/create/ticket/issue"
            exact
            element={<UserIssue />}
          />
          <Route
          ...
          />
          <Route
            path="/admin/configuration/ticket/type"
            exact
            element={<AdminTicketType />}
          />
          <Route
            path="/admin/configuration/stages"
            exact
            element={<AdminStages />}
          />
          <Route
          ...
          />
          <Route
            path="/admin/configuration/stages/type"
            exact
            element={<AdminStageType />}
          />
          <Route
            path="/admin/configuration/stages/type/two"
            exact
            element={<AdminStageTypeTwo />}
          />
          <Route
            path="/admin/configuration/pending/tickets"
            exact
